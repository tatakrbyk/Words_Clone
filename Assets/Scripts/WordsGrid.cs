...
public class WordsGrid : MonoBehaviour
{
    ...
    private Vector3 GetSquareScale(Vector3 defaultScale)
    {
        ...
        var adjustment = 0.01f; // the value of how much we scale a given frame up or down based on the iteration

        while (ShouldScaleDown(finalScale)) // if the board doesn't fit on the screen
        {
    ...
    // Will the entire board fit the screen? Will it scale? Scale Down until it fits the screen
